  ...
  return (
    ...
    >
      <div className="font-pp-neue-montreal relative z-10 flex items-center gap-3 text-[17px] leading-8 font-medium">
        <p className="group-hover/item:text-blue-600 group-hover/item:drop-shadow-[0_0_0.7px_rgba(59,130,246,0.35)]">
          {title}
        </p>
        {description && (
          <p className="font-switzer text-[17px] font-medium text-gray-500/90 group-hover:text-gray-700">
            {description}
          </p>
        )}
      </div>
