...
export default async function FamilyDrawer() {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <p className="mb-2 max-w-2xl text-paragraph">
      ...
      <p className="max-w-2xl text-paragraph">
      ...
      <div className="mx-auto my-4 flex max-w-2xl gap-6">
        ...
        <p className="hidden text-[16px] text-gray-500/60 dark:text-gray-400/60 md:block">
...
>
  ...
  <RecoveryView key="recovery" ... />,
      ...
      <p className="mt-8 max-w-2xl text-paragraph">Thank you for reading!</p>
    </div>
  )
}
